...
object VariableDeclarationLower : Ast2FirLower<CyanVariableDeclaration, FirVariableDeclaration> {
    ...
    override fun lower(astNode: CyanVariableDeclaration): FirVariableDeclaration {
        return FirVariableDeclaration(astNode.name.value, ExpressionLower.lower(astNode.value))
    }
