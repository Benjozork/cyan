...
interface WasmBlock : Wasm.OrderedElement {
    ...
    fun br(blockNum: Int): Boolean {
        val prefix = if (this is WasmLoopBuilder) "L" else "B"
    ...
    @WasmInstructionsBuilderDsl
    operator fun Wasm.OrderedElement.unaryPlus() = this@WasmBlock.pushElement(this)
